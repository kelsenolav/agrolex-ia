...
export function inferirPontuacoesDeAchados(
  ...
  // Keywords expandidas: cada entrada é uma string normalizada (NFD + lowercase + sem acentos).
  // Isso reduz a variância entre textos equivalentes mas redigidos de forma diferente pela IA.
  const KEYWORDS_V2_2: Record<string, string[]> = {
    D1: [
      'origem', 'título originario', 'titulo originario', 'titulo', 'sesmaria', 'incra',
      'reforma agraria', 'regularizacao fundiaria',
      'regularizacao', 'reurb', 'terra legal', 'lei 13.465',
      'itertins', 'iterma', 'titulo estadual',
      'clausula resolutiva', 'titulo definitivo',
      'titulo provisorio', 'posse de fato',
      'sem titulo', 'escritura', 'escritura publica',
      'registro do titulo', 'titulo de dominio', 'dominio pleno',
      'titulo de posse', 'concessao de direito', 'concessao real',
      'titulo de propriedade', 'propriedade plena',
    ],
    D2: [
      'cadeia dominial', 'cadeia', 'cadeia dominial registral',
      'cadeia de dominio', 'transmissao', 'transmitente',
      'lacuna', 'lacuna na cadeia', 'lacuna dominial',
      'continuidade', 'sucessao', 'heranca', 'inventario',
      'partilha', 'espolio', 'capacidade', 'legitimidade',
      'pj extinta', 'restricao legal', 'interdicao',
      'sequencia de proprietarios', 'historico de transmissoes',
      'historico registral', 'cadeia de proprietarios',
      'adquirente', 'alienante', 'vendedor', 'comprador',
      'cessao de direitos', 'compromisso de compra e venda',
      'contrato de compra e venda',
    ],
    D3: [
      'registro', 'registral', 'matricula', 'cartorio',
      'certidao', 'certidao de inteiro teor',
      'penhora', 'bloqueio', 'averbacao', 'onus', 'onus reais',
      'hipoteca', 'alienacao fiduciaria',
    ...
    D4: [
      ...
      'area protegida', 'embargo ambiental',
    ...
    D5: [
      ...
      'tribunal', 'justica', 'demanda', 'reintegracao',
      'manutencao', 'interdito', 'proibitorio',
      'possessoria', 'embargo judicial',
      'liminar', 'tutela', 'antecipacao',
      'recurso', 'apelacao', 'agravo', 'sentenca',
      'execucao', 'correicao', 'cgj',
      'representacao', 'ministerio publico', 'mp',
      'acao em curso', 'acao judicial', 'reclamacao',
      'conflito possessorio', 'disputa de propriedade',
      'usucapiao proposta', 'usucapiao em curso',
      'processo administrativo', 'processo no incra',
      'processo de revisao',
    ],
    D6: [
      'contexto', 'geopolitico', 'conflito fundiario',
      'posseiro', 'posseiros', 'grilagem', 'grilo',
      'assentamento', 'pnra', 'fronteira agricola',
      'pressao fundiaria', 'movimento', 'ocupacao',
      'conflito regional', 'dinamica fundiaria',
      'conflito de terra', 'reforma agraria',
      'movimento social', 'invasao', 'ocupacao organizada',
      'area de conflito', 'comunidade quilombola',
      'comunidade indigena', 'terra indigena',
      'pressao de posseiros',
    ],
  };
